    ...
    <AuthLayout>
      <div className="w-full p-4 flex flex-col" style={{ maxWidth: 250 }}>
        <div className="p-2 bg-pale rounded-md flex flex-col items-center">
          ...
          <button
            onClick={handleFirstPartySignIn}
            className={`w-full h-10 mt-2 mb-2 pl-2 pr-2 flex items-center justify-center rounded-md bg-green hover:bg-swampgreen`}
          >
            <p className={`font-semibold text-darkgreen`}>Sign In!</p>
          </button>

          <div className="w-full flex items-center">
            <button className="leading-6 flex-grow text-sm text-center rounded-md pl-2 pr-2 text-dark hover:bg-green">
              Forgot Password?
            </button>
            <Link href="/signup">
