...
const DocumentMetadata = () => {
    ...
    return <div className="np-h-full np-mr-2 np-max-w-48 np-flex np-flex-col np-items-start np-justify-center np-overflow-hidden">
        <button className="np-h-6 np-mb-0.5 np-pr-2 np-flex np-items-center np-rounded-sm np-pointer-events-auto np-group hover:np-cursor-pointer">
            ...
            <p className="np-text-sm np-text-dark np-font-light np-font-panel np-font-[800] np-whitespace-nowrap np-leading-3 -np-translate-y-1 group-hover:np-underline" style={{ textDecorationThickness: '2px' }}>
                My document
            </p>
        </button>
        ...
        <p className="np-text-xs np-mb-px np-text-left np-text-dark np-font-light np-font-panel np-font-[800] np-whitespace-nowrap np-leading-3 -np-translate-y-1">
          My Speckle Model
        </p>
        <p className="np-text-xs np-text-left np-text-dark np-font-light np-font-panel np-font-[800] np-whitespace-nowrap np-leading-3 -np-translate-y-1">
