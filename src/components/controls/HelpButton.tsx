...
const HelpButton = () => {
    ...
    return (
        <div className='np-w-12 np-h-12 np-mr-4 np-relative np-overflow-visible'>
            <div className="np-absolute np-z-0 np-w-full np-h-full">
                <svg className="np-w-12 np-h-12 np-overflow-visible np-animate-march-rotate" viewBox="0 0 10 10" style={{ animationDuration: '20000ms' }}>
                    ...
                    <circle cx={5} cy={5} r={r} fill="none" stroke={COLORS.DARK} strokeWidth={2} strokeDasharray={dashArray} vectorEffect="non-scaling-stroke" />
                </svg>
            </div>
