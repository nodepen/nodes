...
export const DIMENSIONS = {
    ...
    NODE_PORT_RADIUS: 5,
    NODE_PORT_FLAG_SIZE: 18,
    NODE_PORT_CHIP_SIZE: 9,
    NODE_NO_OUTPUT_MARGIN: 5,
    CLUSTER_PREVIEW_WIDTH: 96,
    CLUSTER_PREVIEW_HEIGHT: 72,
    /** NODE_LABEL_WIDTH + 2 */
...
export const COMPONENTS = {
    ...
    CULL_DUPLICATES: '6eaffbb2-3392-441a-8556-2dc126aa8910',
    BOUNDING_BOX: '0bb3d234-9097-45db-9998-621639c87d3b',
}

export const SUPPORTED_TOGGLE_TEMPLATES: string[] = [COMPONENTS.CULL_DUPLICATES, COMPONENTS.BOUNDING_BOX]
