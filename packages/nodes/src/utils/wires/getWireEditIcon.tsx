    ...
    case 'set': {
      return (
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M8 18V21C8 22.1046 8.89543 23 10 23H13" stroke="#333333" stroke-width="2" stroke-linecap="round" />
        </svg>
      )
    }
    case 'merge': {
      ...
      return (
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            stroke-linejoin="round"
          />
          <line x1="22" y1="23.5001" x2="11" y2="23.5001" stroke="#333333" stroke-width="2" stroke-linecap="round" />
          <path
